...
states["level1"] = {
    ...
    onEnter = function(self)
        ...
        self.layout = getKeyboardLayout(w / 2, h * 0.42)
    ...
    onDraw = function(self)
        ...
        for y = 1, h do
            ...
            love.graphics.rectangle("fill", 0, y, w, 1)
                ...
                -- Title bar
        local titleY = math.floor(h * 0.05)
        ...
        love.graphics.printf("Level 1 -- Intro     Press Esc to go back",
                             w / 2, titleY, math.floor(w * 0.9), "center")
        ...
        if self.showInstructions then
            ...
            love.graphics.setFont(love.graphics.newFont(math.floor(20 * baseScale)))
            ...
            love.graphics.printf("Press the keyboard letters to explode the spheres!",
                                 w / 2, instrY, math.floor(w * 0.85), "center")
        end
        ...
        if allDone and self.hintTimer > 0 then
            ...
            love.graphics.setFont(love.graphics.newFont(math.floor(18 * baseScale)))
            love.graphics.setColor(0.50, 0.65, 0.80, hintAlpha)
            love.graphics.printf("Press any key to restart the level", w / 2, h - 40 * baseScale,
        ...
        elseif self.totalExplosions > 0 then
            ...
            love.graphics.printf(
                    "Exploded: " .. self.totalExplosions .. "/" .. #self.spheres
                        .. "       |   Remaining: " .. remaining,
                w / 2, h - 40 * baseScale, math.floor(w * 0.80), "center")
        end
